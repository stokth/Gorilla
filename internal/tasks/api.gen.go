...
type GetTasks200JSONResponse []TaskModel
...
type PostTasks201JSONResponse TaskModel
...
type GetTasksId200JSONResponse TaskModel
...
type PatchTasksId200JSONResponse TaskModel
...
func (sh *strictHandler) GetTasksId(ctx echo.Context, id int) error {
