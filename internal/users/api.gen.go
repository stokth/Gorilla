...
// UserRequestModel defines model for UserRequestModel.
...
type ServerInterface interface {
	...
	// (GET /users/{id}/tasks)
	GetUsersIdTasks(ctx echo.Context, id int) error
}
...
type GetUsers200JSONResponse []UserModel
...
type PostUsers201JSONResponse UserModel
...
type GetUsersId200JSONResponse UserModel
...
type PatchUsersId200JSONResponse UserModel
...
type GetUsersIdTasks200JSONResponse []TaskModel
...
func (sh *strictHandler) GetUsersId(ctx echo.Context, id int) error {
...
func (sh *strictHandler) GetUsersIdTasks(ctx echo.Context, id int) error {
