...
type UserServiceClient interface {
	...
	GetTasksForUser(ctx context.Context, in *GetTaskForUserRequest, opts ...grpc.CallOption) (*GetTaskForUserResponse, error)
}
...
func (c *userServiceClient) GetTasksForUser(ctx context.Context, in *GetTaskForUserRequest, opts ...grpc.CallOption) (*GetTaskForUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTaskForUserResponse)
...
type UserServiceServer interface {
	...
	GetTasksForUser(context.Context, *GetTaskForUserRequest) (*GetTaskForUserResponse, error)
...
func (UnimplementedUserServiceServer) GetTasksForUser(context.Context, *GetTaskForUserRequest) (*GetTaskForUserResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTasksForUser not implemented")
}
...
func _UserService_GetTasksForUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetTasksForUser(ctx, req.(*GetTaskForUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "project-protos/proto/user.proto",
}
